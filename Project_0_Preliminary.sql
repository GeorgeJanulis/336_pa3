...
-- you will need to change the path here to match the actual path you have the hmda csv

--\copy Preliminary from '/common/home/jmw461/Downloads/hmda_2017_nj_all-records_labels.csv' with (FORMAT csv, HEADER true)
\copy Preliminary from '/mnt/c/Users/Chris/Desktop/CS_336/project1/hmda_2017_nj_all-records_labels.csv' with (FORMAT csv, HEADER true)

alter table Preliminary add ID serial
